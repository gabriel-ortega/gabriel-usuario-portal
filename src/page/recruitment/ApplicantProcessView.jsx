...

{
  /* <div className="flex items-center space-x-3">
                {getStageIcon(userData.recruitmentStage > 2)}
                <span className="text-sm font-medium">First Interview</span>
                {userData.recruitmentStage > 2 && (
                  <span className="text-xs text-gray-500">
                    ({userData.firstInterview.date || "--"})
                  </span>
                )}
                {userData.recruitmentStage === 2 && (
              ...
              <div className="flex items-center space-x-3">
                {getStageIcon(userData.recruitmentStage > 3)}
                <span className="text-sm font-medium">Second Interview</span>
                {userData.recruitmentStage > 3 && (
                  <span className="text-xs text-gray-500">
                    ({userData.secondInterview.date || "--"})
                  </span>
                )}
                {userData.recruitmentStage === 3 && (
                  <span className="text-xs text-yellow-600">{"--"}</span>
              ...
              <div className="flex items-center space-x-3">
                {getStageIcon(userData.recruitmentStage > 5)}
                <span className="text-sm font-medium">Hiring Process</span>
           
              </div>

              <div className="flex items-center space-x-3">
                {getStageIcon(userData.recruitmentStage > 6)}
                <span className="text-sm font-medium">Embarkation Process</span>
