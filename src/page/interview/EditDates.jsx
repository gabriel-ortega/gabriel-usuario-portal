      ...
      datesArray.filter((interview) => {
        ...
        const matchesStart = dataValue.dateI
          ? new Date(interview.start).setHours(0, 0, 0, 0) >=
            normalizeDate(dataValue.dateI).setHours(0, 0, 0, 0)
          : true;
        const matchesEnd = dataValue.dateF
          ? new Date(interview.end).setHours(0, 0, 0, 0) <=
            normalizeDate(dataValue.dateF).setHours(0, 0, 0, 0)
          : true;
  ...
  return (
    <>
              ...
              <div className="">
                <label className="flex gap-2">
                  <input
                    ...
                    checked={
                      interviewFilter.interviewer?.includes(interviewer.id) ||
                      false
      ...
      <button
        ...
        className="mt-2 w-36 text-center rounded-md bg-gray-400 text-white h-10"
      >
        clean filter
      </button>
