export const getSeafarerDataObject = (applicantData) => {
  const replaceApplicationWithSeafarer = (key) =>
    ...
    key.replace(/application|applicant/g, "seafarer");
...
// export const getSeafarerDataObject = (applicantData) => {
//   const replaceApplicationWithSeafarer = (key) =>
//     key.replace(/application|applicant/g, "seafarer"); // Reemplazar ambas palabras con "seafarer"
...
//   // Transformar el objeto y reemplazar "application" o "applicant" por "seafarer"
//   let transformedData = transformObjectKeys(applicantData);
...
//   // Filtrar los elementos en los arreglos seafarerDocument y seafarerCertificates
//   if (transformedData.seafarerDocument) {
//     transformedData.seafarerDocument = filterIncompleteItemsDocument(
//       transformedData.seafarerDocument
//     );
...
//   // Extraer los arreglos dentro de startSeafarer al nivel superior
//   const { vesselType, department, position } = transformedData.startSeafarer;
...
//   // Eliminar el objeto startSeafarer ahora vacío
//   delete transformedData.startSeafarer;
